...
class WordAdapter(val words: ArrayList<WordList>) : RecyclerView.Adapter<WordAdapter.WordViewHolder>(){
    var onClick: ((WordList) -> Unit)? = null

    class WordViewHolder(itemView: View):RecyclerView.ViewHolder(itemView) {
        var button = itemView.findViewById<Button>(R.id.action_switch_layout)
    }
